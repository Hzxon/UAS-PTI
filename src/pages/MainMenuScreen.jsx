...
const MainMenuScreen = () => {
    ...
    return (
        <div className="relative w-screen h-screen items-center justify-center bg-[url('/images/gambar/tampilan-mobile.gif')] md:bg-[url('/images/gambar/tampilan-awal.gif')] bg-cover bg-center bg-fixed font-utama text-white overflow-hidden" onClick={handlePlayBgMusic}>
            {/* Transition Layer */}
            <div
